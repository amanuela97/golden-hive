...
const CreateOrderForm = forwardRef<CreateOrderFormRef, CreateOrderFormProps>(
  function CreateOrderForm(
    ...
    // Summary (currency is now managed by marketCurrency)
        ...
        if (draftId) {
          ...
          try {
            ...
            if (draftResult.success && draftResult.data) {
              setCurrentDraftNumber(Number(draftResult.data.draftNumber));
        ...
        if (isEditMode && draftId) {
          ...
          if (result.success && result.draftId) {
            ...
            setCurrentDraftNumber(
              result.draftNumber ? Number(result.draftNumber) : null
            );
